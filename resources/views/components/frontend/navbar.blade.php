    ...
    <div class="container mx-auto py-5">
        ...
        <div class="w-auto">
            ...
            <li class="mx-3 py-6 md:py-0">
                <a href="#" class="text-black {{ \Route::currentRouteName() == 'index' ? 'md:text-white' : '' }} hover:underline"
                >Showcase</a
                >
            </li>
            <li class="mx-3 py-6 md:py-0">
            ...
            @auth
                <li class="mx-3 py-6 md:py-0">
                    <a href="{{ route('dashboard.index') }}" class="text-black {{ \Route::currentRouteName() == 'index' ? 'md:text-white' : '' }} hover:underline">Dashboard</a>
                </li>                
            @endauth
            @guest
                <li class="mx-3 py-6 md:py-0">
                    <a href="{{ route('login') }}" class="text-black {{ \Route::currentRouteName() == 'index' ? 'md:text-white' : '' }} hover:underline">Login</a>
                </li>
                <li class="mx-3 py-6 md:py-0">
                    <a href="{{ route('register') }}" class="text-black {{ \Route::currentRouteName() == 'index' ? 'md:text-white' : '' }} hover:underline">Register</a>
                </li>
            @endguest
            </ul>
        </div>
        <div class="w-auto">
            ...
            <li class="ml-6 block md:hidden">
                <button
                id="menu-toggler"
                class="relative flex z-50 items-center justify-center w-8 h-8 text-black {{ \Route::currentRouteName() == 'index' ? 'md:text-white' : '' }} focus:outline-none"
                >
                <svg
                    class="fill-current"
                    width="18"
            ...
            <li class="ml-6">
                <a
                id="header-cart"
                class="flex items-center justify-center w-8 h-8 text-black {{ \Route::currentRouteName() == 'index' ? 'md:text-white' : '' }}"
                href="cart.html"
                >
                <svg
                    class="fill-current"
